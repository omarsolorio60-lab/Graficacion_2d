...
uint32_t ui_fill_color   = 0xAA5500FF; // color de relleno inicial 
uint32_t ui_stroke_color = 0x000000FF; // color de borde inicial NEGRO
...
int main(int argc, char** argv)
{
    ...
    while(estadosrender.run)
    {
        ...
        {
            minipaint_handle_event(&estadosrender.evento);
                ui_fill_color   = minipaint_get_fill_color();
                ui_stroke_color = minipaint_get_stroke_color();
            render_input();
